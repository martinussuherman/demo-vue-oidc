...
export function createOidcCustomEvent<T> (eventName: string, params: OidcCustomEventInit<T>) {
...
export function dispatchCustomBrowserEvent<T> (eventName: string, params: OidcCustomEventInit<T>) {
  if (window) {
